...
const MenuGenerator = () => {
  ...
  const analyzeSalesData = () => {
    ...
    const topItems = [
      {
        id: 113,
        name: "Pork Siu Mai",
        description: "Steamed dumplings with pork and shrimp filling, topped with fish roe",
        price: 5.0,
    ...
    const suggestedItems = [
      {
        ...
        aiSuggested: true,
        similarToId: 113,
        reasonForSuggestion: "Premium variation of popular dumpling items with higher profit margin"
      },
      {
        id: 'new-2',
      ...
      {
        id: 'new-3',
        name: "Crispy Taro Puffs",
        description: "Flaky pastry filled with mashed taro and diced chicken",
        price: 5.95,
        category: "Pan Fried",
        popular: false,
        imageUrl: "taropuff.jpg",
        isNew: true,
        aiSuggested: true,
        similarToId: 217,
        reasonForSuggestion: "Diversify crispy/fried options menu with unique flavor profile"
      }
    ];
    ...
    setSalesData({
      ...
      mostProfitableCategory: "Steamed Dumplings",
      bestSellingCategory: "Steamed Dumplings",
